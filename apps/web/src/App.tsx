...
function App() {
  ...
  const [bridgeSageShowPolis, setBridgeSageShowPolis] = useState(true);
  const [bridgeSageResourcesFilter, setBridgeSageResourcesFilter] = useState<Set<string>>(
    new Set(["food", "ammunition", "toolkit", "fuel"]),
  );
